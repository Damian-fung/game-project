...
這是一個基於深度強化學習（Deep Q-Network, DQN）的雙 AI 貪吃蛇對戰系統，使用 Pygame 實現遊戲視覺化。兩條 AI 蛇會通過深度學習持續改進策略，互相競爭以獲取食物並攻擊對方。

### 核心特色

- ✅ **深度強化學習**：使用 PyTorch 實現的 DQN 算法
- ✅ **雙 AI 對戰**：兩條蛇同時訓練，互相學習對抗策略
...
⚠️ **需要 Python 3.10 或以上版本**

- **下載 Python**: https://www.python.org/downloads/
- **安裝時請勾選「Add Python to PATH」**
- 驗證安裝：
  ```bash
  python --version  # 應顯示 Python 3.10.x 或更高版本
  ```
